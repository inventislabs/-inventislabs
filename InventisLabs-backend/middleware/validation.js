...
const validateJob = [
    ...
    body('jobId')
        ...
        .matches(/^[A-Z0-9-]+$/).withMessage('Job ID can only contain uppercase letters, numbers, and hyphens'),
...
const validateJobUpdate = [
    ...
    body('pinned')
        .optional()
        .isBoolean().withMessage('Pinned must be a boolean value'),
...
const validateMessageUpdate = [
    ...
    body('read')
        .optional()
        .isBoolean().withMessage('Read must be a boolean value'),

    body('starred')
        .optional()
        .isBoolean().withMessage('Starred must be a boolean value'),
