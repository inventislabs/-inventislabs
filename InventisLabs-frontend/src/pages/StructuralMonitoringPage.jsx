        ...
        <section className="py-32 bg-white dark:bg-black">
          <div className="max-w-5xl mx-auto px-6 text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed font-light">
              Real-time surveillance of bridges, buildings, dams, and industrial
              foundations using AI-powered diagnostics and predictive analytics.
            </p>
          </div>
        </section>
        ...
        <section className="py-28 bg-[#F5F5F7] dark:bg-zinc-900">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed max-w-3xl">
              Structural Monitoring systems continuously measure vibration,
              strain, tilt, displacement, and environmental stress across
              critical assets. By combining high-precision IoT sensors with AI
              models trained on structural behavior, the system detects
              anomalies long before visible damage appears.
            </p>
          </div>
        </section>
        ...
        <section className="py-28 bg-white dark:bg-black">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 mb-12 max-w-3xl">
              Our nationwide network of structural monitoring sensors
              continuously tracks infrastructure health across India's seismic
              zones.
            </p>

            {/* Map Container */}
            <div className="relative w-full h-[500px] md:h-[600px] bg-white dark:bg-zinc-900/50 rounded-2xl overflow-hidden border border-gray-200 dark:border-zinc-800 shadow-2xl">
        ...
        <section className="py-24 bg-[#F5F5F7] dark:bg-zinc-900">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 mb-10 font-light">
              Get a customized monitoring solution designed for your asset type
              and risk profile.
            </p>
