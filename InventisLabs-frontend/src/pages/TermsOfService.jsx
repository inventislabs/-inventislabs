      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="policy-content">
          <Section title="Agreement to Terms" icon={FileText}>
            <p>
              We are Inventis Labs ("Company", "we", "us", "our"), a company
              registered in India at A- 44 Vasundhara, Chinhat Lucknow- 226028.
            </p>
            <p>
              We operate the website https://www.inventislabs.com (the "Site"),
          ...
          <Section title="Prohibited Activities" icon={Eye}>
            ...
            <p>
              Systematic retrieval of data or other content from the Services to
              create or compile, directly or indirectly, a collection,
              compilation, database, or directory without written permission
              from us is prohibited.
            </p>
          </Section>
