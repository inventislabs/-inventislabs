      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="careers-header text-center mb-12 md:mb-20">
          ...
          <p className="text-xl text-gray-500 dark:text-gray-400 max-w-2xl mx-auto">
            ...
            of earthquake early warning technology.
          </p>
        </div>
            ...
            filteredJobs.map((job) => {
              ...
              return (
                <div
                  key={job._id || job.id}
                  onClick={() =>
                    setExpandedJobId(isExpanded ? null : job._id || job.id)
                  }
                ...
                >
                  <div className="flex flex-col md:flex-row justify-between gap-6">
                    <div className="flex-1">
                      ...
                      <p
                        className={`text-gray-600 dark:text-gray-400 max-w-3xl ${isExpanded ? "" : "line-clamp-2"}`}
                      >
                        {job.description}
                      </p>
                    ...
                    <div className="shrink-0 flex flex-col items-end gap-4">
                      <a
                        href={`mailto:support@inventislabs.com?subject=Application for ${job.title}`}
