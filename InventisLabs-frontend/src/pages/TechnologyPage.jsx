...
const TechnologyPage = () => {
  return (
    <div className="min-h-screen bg-white dark:bg-black text-[#1d1d1f] dark:text-white font-display pt-20 transition-colors duration-500">
      {/* Page Header */}
      <section className="bg-[#F5F5F7] dark:bg-zinc-900 py-12 sm:py-16 md:py-20 lg:py-28 px-4 sm:px-6">
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-32 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-20 items-center">
          ...
          <div className="bg-gray-50 dark:bg-zinc-900 p-4 sm:p-6 md:p-8 lg:p-10 rounded-2xl sm:rounded-3xl border border-gray-100 dark:border-white/5 shadow-lg">
            <div className="flex flex-col gap-4 sm:gap-6">
              ...
              <div className="h-6 sm:h-8 w-0.5 bg-gray-200 dark:bg-white/10 ml-4 sm:ml-5"></div>
      ...
      {/* How EQ Alert Works */}
      <section className="py-12 sm:py-16 md:py-20 lg:py-32 px-4 sm:px-6 bg-[#F5F5F7] dark:bg-zinc-900/50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-5xl mx-auto relative">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 md:gap-10 lg:gap-12 relative z-10">
              {/* Step 1 */}
              <div className="bg-white dark:bg-black p-4 sm:p-6 md:p-8 lg:p-10 rounded-2xl sm:rounded-3xl border border-gray-100 dark:border-white/10 text-center hover:shadow-2xl hover:border-yellow-300 dark:hover:border-yellow-600 transition-all duration-300">
              ...
              {/* Step 2 */}
              <div className="bg-white dark:bg-black p-4 sm:p-6 md:p-8 lg:p-10 rounded-2xl sm:rounded-3xl border border-gray-100 dark:border-white/10 text-center hover:shadow-2xl hover:border-blue-300 dark:hover:border-blue-600 transition-all duration-300">
                <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 mx-auto bg-white dark:bg-black border-2 sm:border-4 border-[#F5F5F7] dark:border-zinc-800 rounded-full flex items-center justify-center mb-4 sm:mb-6 relative">
              ...
              {/* Step 3 */}
              <div className="bg-white dark:bg-black p-4 sm:p-6 md:p-8 lg:p-10 rounded-2xl sm:rounded-3xl border border-gray-100 dark:border-white/10 text-center sm:col-span-2 md:col-span-1 hover:shadow-2xl hover:border-red-300 dark:hover:border-red-600 transition-all duration-300">
                <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 mx-auto bg-white dark:bg-black border-2 sm:border-4 border-[#F5F5F7] dark:border-zinc-800 rounded-full flex items-center justify-center mb-4 sm:mb-6 relative">
      ...
      {/* Indigenous Hardware */}
      <section className="py-12 sm:py-16 md:py-20 lg:py-32 px-4 sm:px-6 bg-white dark:bg-black text-white">
            ...
            <div className="grid md:grid-cols-2 gap-6 sm:gap-8 md:gap-10 lg:gap-12 text-gray-300">
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                {[
                  ...
                  <div
                    key={i}
                    className="bg-white/5 p-3 sm:p-4 md:p-5 rounded-xl sm:rounded-2xl border border-white/10 flex flex-col items-center justify-center text-center gap-1.5 sm:gap-2 hover:bg-white/20 hover:scale-105 hover:border-white/30 transition-all duration-300 cursor-pointer"
                  >
                    {item.icon}
