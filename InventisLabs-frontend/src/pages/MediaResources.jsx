            ...
            <section className="bg-[#F5F5F7] dark:bg-zinc-900 py-20 px-6">
                <div className="max-w-7xl mx-auto">
                    ...
                    <p className="text-xl text-gray-500 dark:text-gray-400 max-w-3xl">
                        Latest announcements, technical explainers, and documents for policy makers and partners.
                    </p>
                </div>
            </section>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mb-20">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            {/* Card 1 */}
                            <div className="group bg-white dark:bg-zinc-900 border border-gray-100 dark:border-white/10 p-8 rounded-2xl hover:shadow-xl transition-all">
                                <div className="flex items-center justify-between mb-4">
                                    <span className="px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 text-xs font-bold uppercase">Proposal</span>
                                    <span className="text-sm text-gray-400">Dec 2024</span>
                                </div>
                                <h3 className="text-xl font-bold mb-3 group-hover:text-blue-600 transition-colors">ASSOCHAM UP – EQ-Alert Pilot Proposal</h3>
                                <p className="text-gray-500 dark:text-gray-400 text-sm mb-6">
                                    A comprehensive proposal for deploying state-wide earthquake early warning systems in Uttar Pradesh.
                                </p>
                            ...
                            <div className="group bg-white dark:bg-zinc-900 border border-gray-100 dark:border-white/10 p-8 rounded-2xl hover:shadow-xl transition-all">
                                <div className="flex items-center justify-between mb-4">
                                    <span className="px-3 py-1 rounded-full bg-purple-50 dark:bg-purple-900/20 text-purple-600 dark:text-purple-400 text-xs font-bold uppercase">Concept Note</span>
                                    <span className="text-sm text-gray-400">Nov 2024</span>
                                </div>
                                <h3 className="text-xl font-bold mb-3 group-hover:text-purple-600 transition-colors">NTTM–GREAT: Smart Geotechnical Textiles</h3>
                                <p className="text-gray-500 dark:text-gray-400 text-sm mb-6">
                                    Technical concept note on integrating IoT sensors with geotechnical textiles for infrastructure safety.
                                </p>
                                <button className="text-sm font-semibold flex items-center gap-2 text-gray-900 dark:text-white group-hover:gap-3 transition-all">
                                    Read More <ArrowRight size={16} />
                                </button>
                    ...
                    <div>
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            {/* Card 3 */}
                            <div className="bg-gray-50 dark:bg-zinc-900 p-6 rounded-2xl border border-gray-100 dark:border-white/5">
                                ...
                                <p className="text-xs text-gray-500 mb-4">A simple guide to understanding P-waves, S-waves, and warning times.</p>
                            ...
                            <div className="bg-gray-50 dark:bg-zinc-900 p-6 rounded-2xl border border-gray-100 dark:border-white/5">
                                ...
                                <p className="text-xs text-gray-500 mb-4">Detailed specs of EQ-Alert sensors, sirens, and gateways.</p>
                                <button className="w-full py-2 rounded-lg bg-white dark:bg-black border border-gray-200 dark:border-white/10 text-xs font-bold flex items-center justify-center gap-2 hover:bg-gray-100 dark:hover:bg-white/10 transition-colors">
                                    <Download size={14} /> Download PDF
                                </button>
                            </div>
